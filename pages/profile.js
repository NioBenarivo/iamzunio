    ...
    <motion.div exit={{ opacity: 0 }} className="top" ref={containerRef}>
      ...
      <div className="landing">
        <motion.h1 initial="hidden" animate="visible" variants={headline(isFirstMount)}>
          ...
          <motion.span variants={text}>Engineer</motion.span> <br />
          ...
          <motion.span variants={text}>about</motion.span> <br />
        ...
        <div className="wrapper">
          <StaggerWrapper>
            <div className="stack-container">
              <motion.h2 variants={text} className="center">
                My Stack Universe
              </motion.h2>
        ...
        <div className="wrapper">
          <StaggerWrapper inViewProps={{ threshold: '0.5' }}>
            ...
            <motion.a
              ...
              rel="noopener noreferrer"
            >
              <motion.p variants={text} className="left-align">
                Binus
              </motion.p>
              <motion.p variants={text} className="center">
                International
              </motion.p>
              <motion.p variants={text} className="right-align">
                University
              </motion.p>
            </motion.a>
            <motion.h4 variants={text} className="right-align">
          ...
          <StaggerWrapper className="contact" inViewProps={{ threshold: '0.5' }}>
            ...
            <div className="flex items-center contact-info">
              ...
              <motion.p variants={text}>
                Jl. Pantai Indah Selatan 2, RT.3/RW.3, Kapuk Muara, Kec. Penjaringan, Kota Jkt
                Utara, Daerah Khusus Ibukota Jakarta 14460
              </motion.p>
            </div>
            <div className="flex items-center contact-info">
              <motion.div variants={scaledIcon}>
